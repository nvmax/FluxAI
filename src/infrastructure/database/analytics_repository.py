...
class SQLiteAnalyticsRepository(AnalyticsRepository):
    ...
    async def reset_analytics(self) -> bool:
        ...
        try:
            ...
            self.database_service.drop_table("command_usage")
            self.database_service.drop_table("user_activity")
            self.database_service.drop_table("image_stats")
            self.database_service.drop_table("daily_stats")
