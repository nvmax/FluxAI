...
class ComfyUIValidator:
    ...
    def copy_gguf_reader(self, source_dir: str, dest_dir: str) -> bool:
        ...
        try:
            ...
            source_path = Path(source_dir) / "setup" / "required_files" / "Comfyui files" / "python_embeded" / "Lib" / "site-packages" / "gguf" / "gguf_reader.py"
    ...
    def copy_upscaler(self, source_dir: str, dest_dir: str) -> bool:
        ...
        try:
            ...
            source_path = Path(source_dir) / "setup" / "required_files" / "Comfyui files" / "models" / "upscale_models" / "4x-ClearRealityV1.pth"
    ...
    def copy_ratios_json(self, source_dir: str, dest_dir: str) -> bool:
        ...
        try:
            ...
            source_path = os.path.join(source_dir, "setup", "required_files", "ratios.json")
